...
var app = (function () {
    ...
    /* src/Tabs.svelte generated by Svelte v3.31.0 */
    ...
    /* src/TabList.svelte generated by Svelte v3.31.0 */

    const file$1 = "src/TabList.svelte";
    ...
    /* src/TabPanel.svelte generated by Svelte v3.31.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 26, 0, 417);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
